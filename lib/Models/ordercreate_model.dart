...
class OrderCreateModel {
  ...
  OrderCreateModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['line_items'] != null) {
      lineItems = <LineItemss>[];
      json['line_items'].forEach((v) {
        lineItems!.add(LineItemss.fromJson(v));
      });
    }
...
class LineItemss {
  ...
  LineItemss({this.productId, this.quantity, this.variationId});

  LineItemss.fromJson(Map<String, dynamic> json) {
